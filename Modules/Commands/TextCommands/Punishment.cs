...
namespace DiscordBot.Modules.Commands.TextCommands
{
    ...
    //
    //                     await Rest.SendMessageEmbedToUser(mutedUser, embed, Context);
    ...
    //
    //                     await Rest.SendMessageEmbedToUser(unmutedUser, embed, Context);
    //                     await EventHandlers.LogViolation(embed, Context.Guild);
    ...
    //
    //                 await Rest.SendMessageEmbedToUser(kickedUser, embed, Context);
    ...
    //
    //                 await Rest.SendMessageEmbedToUser(bannedUser, embed, Context);
