...
using DiscordBot.Discord.Modules.Chat.EventHandlers;
using DiscordBot.Discord.Modules.DynamicChannels;
using DiscordBot.Discord.Modules.Logging;
using DiscordBot.Discord.Modules.Logging.Embeds;
using DiscordBot.Discord.Modules.Logging.Embeds.Channel;
using DiscordBot.Discord.Modules.Logging.Embeds.Member;
using DiscordBot.Discord.Modules.Logging.Embeds.Messages;
using DiscordBot.Discord.Modules.Logging.Embeds.Punishments;

namespace DiscordBot.Discord.Modules.Event
{
    public static class EventHandlers
    {
        private static IServiceProvider _serviceProvider = Bot.Services;
        ...
        {
            JoinedGuild.AddGuild(guild, Bot.Services);
            JoinedGuild.DownloadMembers(guild.Users, guild.Id, Bot.Services);
            JoinedGuild.SetGuildOwner(guild.OwnerId, guild.Id, Bot.Services);
            JoinedGuild.GenerateDefaultViolation(guild, Bot.Services);
