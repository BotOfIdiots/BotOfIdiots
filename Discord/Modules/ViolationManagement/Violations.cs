...
using DiscordBot.Discord.Modules.ViolationManagement.Objects;

namespace DiscordBot.Discord.Modules.ViolationManagement
{
    ...
    public class Violations : InteractionModuleBase<ShardedInteractionContext>
    {
        ...
        public async Task Remove(int violationId, String reason = "No reason specified")
        {
            ...
            {
                Violation violation =
                    global::DiscordBot.Discord.Modules.ViolationManagement.Objects.Violation.Select(Context.Guild.Id, violationId, DatabaseService, Context.Client);
